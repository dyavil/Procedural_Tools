...
void init(HeightField &hf, Display &w, int nbrayon, bool renderImage=false){
    ...
    vegetationField test = vegetationField(Vector2(-2000, -2000), Vector2(2000, 2000), 0.0, 20.0);
    test.render().save(QString(resdir) + QString("testpoissonprev.png"));
    test.adaptVegetation(hf);
